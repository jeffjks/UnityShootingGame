...
namespace ND_VariaBULLET
{
    ...
    public abstract class AutomateBase : MonoBehaviour
    {
        ...
        protected Func<float, float, int, float> method;

        protected SpreadPattern pattern;

        protected int accumulator;
        protected int accumulatorTotal;
        ...
        protected virtual void Awake()
        {
            ...
            var behaviors = new Func<float, float, int, float>[4] {
        ...
        protected abstract float SinglePass(float p1, float p2, int p3);
        protected abstract float Continuous(float p1, float p2, int p3);
        protected abstract float PingPong(float p1, float p2, int p3);
        protected abstract float Randomized(float p1, float p2, int p3);
