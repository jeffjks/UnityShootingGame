...
namespace ND_VariaBULLET
{
    public class ShotBoomerang : ShotBaseColorizable, IRePoolable
    {
        ...
        {
            transform.position = Vector3.MoveTowards(transform.position, Emitter.transform.position, scaledSpeed * ReturnSpeed / Application.targetFrameRate * Time.timeScale);
            checkReturned();
        }
        ...
        private void checkReturn()
        {
            ...
            returnTimer.Run((int) (returnLimit * returnScale));
        }
