...
public class EnemyShipSmall2Turret : EnemyUnit
{
    ...
    private IEnumerator Pattern1() {
        ...
        while (true) {
            ...
            CreateBullet(2, pos, speed[(int) m_SystemManager.GetDifficulty()]*0.9f, target_angle, accel);
            CreateBullet(2, pos, speed[(int) m_SystemManager.GetDifficulty()], target_angle, accel);
            CreateBullet(2, pos, speed[(int) m_SystemManager.GetDifficulty()]*1.1f, target_angle, accel);
