...
{
    public GameObject[] PlayerWeapon = new GameObject[4];
    ...
    protected string[] m_PlayerWeaponName = new string[4];
    ...
    protected abstract void CreatePlayerAttacks(string name, Vector3 pos, float dir, byte type = 0);
    public abstract void SetPreviewShooter();

    private event Action createModuleEvent;
    ...
    protected void CreateShotNormal(int level) {
        ...
        if (level <= 1) { // ----------------------------------[ 0 0 0 0 0 ]
            for (int i = 0; i < 5; i++) {
                CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[i], shotDirection[i], 0);
            }
        }
        else if (level <= 3) { // ---------------------------------- [ 0 1 0 1 0 ]
            CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[0], shotDirection[0], 0);
            for (int i = 1; i < 3; i++) {
                CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[i], shotDirection[i], 1);
                CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[i+2], shotDirection[i+2], 0);
            }
        }
        else { // ---------------------------------- [ 0 1 2 1 0 ]
            CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[0], shotDirection[0], 2);
            CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[1], shotDirection[1], 1);
            CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[2], shotDirection[2], 1);
            CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[3], shotDirection[3], 0);
            CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[4], shotDirection[4], 0);
        }
    }
    ...
    protected void CreateShotVeryStrong(int level) {
        ...
        if (level <= 1) { // ---------------------------------- [ 0 1 1 1 0 ]
            ...
            for (int i = 0; i < 3; i++) {
                CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[i], shotDirection[i], 2);
            }
            CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[3], shotDirection[3], 1);
            CreatePlayerAttacks(m_PlayerWeaponName[0], shotPosition[4], shotDirection[4], 1);
        }
    }
    ...
    private void CreateHomingMissile() {
        ...
        CreatePlayerAttacks(m_PlayerWeaponName[1], new Vector3(shotPosition[0][0], shotPosition[0][1], m_PlayerShotZ), 180f - 15f);
        CreatePlayerAttacks(m_PlayerWeaponName[1], new Vector3(shotPosition[1][0], shotPosition[1][1], m_PlayerShotZ), 180f + 15f);
    }
    ...
    private void CreateRocket() {
        ...
        shotPosition[0] = m_PlayerShotPosition[5].position;
        shotPosition[1] = m_PlayerShotPosition[6].position;
        CreatePlayerAttacks(m_PlayerWeaponName[2], new Vector3(shotPosition[0][0], shotPosition[0][1], m_PlayerShotZ), 180f, damage_level);
        CreatePlayerAttacks(m_PlayerWeaponName[2], new Vector3(shotPosition[1][0], shotPosition[1][1], m_PlayerShotZ), 180f, damage_level);
    }
    ...
    private void CreateAddShot() {
        ...
        CreatePlayerAttacks(m_PlayerWeaponName[3], new Vector3(shotPosition[1][0], shotPosition[1][1], m_PlayerShotZ), 180f + rot, damage_level);
    }
    ...
    protected void SetModule() {
        if (m_Module == 1) {
            ...
            createModuleEvent = CreateHomingMissile;
        }
        else if (m_Module == 2) {
            m_ModuleDelay = m_RocketDelay;
            createModuleEvent = CreateRocket;
        }
        else if (m_Module == 3) {
            m_ModuleDelay = m_AddShotDelay;
            createModuleEvent = CreateAddShot;
        }
        else {
            createModuleEvent = null;
        }
