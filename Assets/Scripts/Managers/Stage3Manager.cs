...
public class Stage3Manager : StageManager
{
    ...
    protected override IEnumerator MainTimeLine()
    {
        ...
        yield return new WaitForMillisecondFrames(38000);
    ...
    protected override IEnumerator EnemyTimeLine()
    {
        ...
        CreateEnemy(m_PlaneSmall_2, new Vector2(Random.Range(-6f, -3f), Random.Range(2f, 4f)));
        CreateEnemy(m_PlaneSmall_2, new Vector2(Random.Range(-3f, 0f), Random.Range(2f, 4f)));
        CreateEnemyWithMoveVector(m_ShipLarge, new Vector3(Size.GAME_BOUNDARY_LEFT - 4f, WATER_HEIGHT, 13f), new MoveVector(1.5f, 80f), new MovePattern[] {new MovePattern(5000, 8739f, 0f, 1000)});
        yield return new WaitForMillisecondFrames(6000);
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(1f, WATER_HEIGHT, 20f), new MoveVector(1.5f, 5f), new MovePattern[] {new MovePattern(3000, 8739f, 0f, 1000)});
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(3.2f, WATER_HEIGHT, 22f), new MoveVector(1.5f, -2f), new MovePattern[] {new MovePattern(3000, 8739f, 0f, 1000)});
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(6f, WATER_HEIGHT, 21f), new MoveVector(1.5f, 1f), new MovePattern[] {new MovePattern(3000, 8739f, 0f, 1000)});
        yield return new WaitForMillisecondFrames(2000);
        ...
        yield return new WaitForMillisecondFrames(2000);
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(0f, WATER_HEIGHT, 25f), new MoveVector(1.5f, 0f), new MovePattern[] {new MovePattern(3700, 8739f, 0f, 1000)});
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(-4.5f, WATER_HEIGHT, 27f), new MoveVector(1.5f, -3f), new MovePattern[] {new MovePattern(3700, 8739f, 0f, 1000)});
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(-6.5f, WATER_HEIGHT, 26f), new MoveVector(1.5f, 2f), new MovePattern[] {new MovePattern(3700, 8739f, 0f, 1000)});
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(-2.8f, WATER_HEIGHT, 26.5f), new MoveVector(1.5f, 0f), new MovePattern[] {new MovePattern(3700, 8739f, 0f, 1000)});
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(Size.GAME_BOUNDARY_RIGHT + 3f, WATER_HEIGHT, 26f), new MoveVector(1.5f, -50f), new MovePattern[] {new MovePattern(5000, 8739f, 0f, 1000)});
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(Size.GAME_BOUNDARY_RIGHT + 4f, WATER_HEIGHT, 24f), new MoveVector(1.5f, -46f), new MovePattern[] {new MovePattern(5000, 8739f, 0f, 1000)});
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(Size.GAME_BOUNDARY_RIGHT + 2f, WATER_HEIGHT, 21f), new MoveVector(1.5f, -40f), new MovePattern[] {new MovePattern(5000, 8739f, 0f, 1000)});
        yield return new WaitForMillisecondFrames(3000);
        ...
        yield return new WaitForMillisecondFrames(6000);
        CreateEnemyWithMoveVector(m_ShipCarrier_1, new Vector3(Size.GAME_BOUNDARY_LEFT + 1f, WATER_HEIGHT, 34.8f), new MoveVector(0.6f, 70f), new MovePattern[] {new MovePattern(7000, 8739f, 0f, 1000)});
        ...
        yield return new WaitForMillisecondFrames(1000);
        CreateEnemyWithMoveVector(m_TankLarge_3, new Vector3(-36.5f, 3f, 26f), new MoveVector(4f, 85f), new MovePattern[] {new MovePattern(1200, 8739f, 0f, 1000)});
