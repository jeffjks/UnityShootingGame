...
public class Stage3Manager : StageManager
{
    ...
    protected override IEnumerator EnemyTimeline()
    {
        ...
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(1f, WATER_HEIGHT, 20f), new MoveVector(1.5f, 5f), new MovePattern[] {new MovePattern(3000, 1000, true, 0f)});
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(3.2f, WATER_HEIGHT, 22f), new MoveVector(1.5f, -2f), new MovePattern[] {new MovePattern(3000, 1000, true, 0f)});
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(6f, WATER_HEIGHT, 21f), new MoveVector(1.5f, 1f), new MovePattern[] {new MovePattern(3000, 1000, true, 0f)});
        yield return new WaitForMillisecondFrames(2000);
        ...
        yield return new WaitForMillisecondFrames(2000);
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(0f, WATER_HEIGHT, 25f), new MoveVector(1.5f, 0f), new MovePattern[] {new MovePattern(3700, 1000, true, 0f)});
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(-4.5f, WATER_HEIGHT, 27f), new MoveVector(1.5f, -3f), new MovePattern[] {new MovePattern(3700, 1000, true, 0f)});
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(-6.5f, WATER_HEIGHT, 26f), new MoveVector(1.5f, 2f), new MovePattern[] {new MovePattern(3700, 1000, true, 0f)});
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(-2.8f, WATER_HEIGHT, 26.5f), new MoveVector(1.5f, 0f), new MovePattern[] {new MovePattern(3700, 1000, true, 0f)});
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(Size.GAME_BOUNDARY_RIGHT + 3f, WATER_HEIGHT, 26f), new MoveVector(1.5f, -50f), new MovePattern[] {new MovePattern(5000, 1000, true, 0f)});
        CreateEnemyWithMoveVector(m_ShipSmall_2, new Vector3(Size.GAME_BOUNDARY_RIGHT + 4f, WATER_HEIGHT, 24f), new MoveVector(1.5f, -46f), new MovePattern[] {new MovePattern(5000, 1000, true, 0f)});
        CreateEnemyWithMoveVector(m_ShipSmall_1, new Vector3(Size.GAME_BOUNDARY_RIGHT + 2f, WATER_HEIGHT, 21f), new MoveVector(1.5f, -40f), new MovePattern[] {new MovePattern(5000, 1000, true, 0f)});
        yield return new WaitForMillisecondFrames(3000);
        ...
        yield return new WaitForMillisecondFrames(6000);
        CreateEnemyWithMoveVector(m_ShipCarrier_1, new Vector3(Size.GAME_BOUNDARY_LEFT + 1f, WATER_HEIGHT, 34.8f), new MoveVector(0.6f, 70f), new MovePattern[] {new MovePattern(7000, 1000, true, 0f)});
