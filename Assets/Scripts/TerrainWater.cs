...
namespace UnityStandardAssets.Water
{
    ...
    public class TerrainWater : MonoBehaviour
    {
        ...
        [HideInInspector] public static float m_WaveSpeed;
        ...
        void Update()
        {
            ...
            waveOffset += new Vector4(
                (float)Math.IEEERemainder(waveSpeed.x * waveScale4.x * Time.deltaTime / 20, 1.0),
                (float)Math.IEEERemainder((waveSpeed.y + m_WaveSpeed) * waveScale4.y * Time.deltaTime / 20, 1.0),
                (float)Math.IEEERemainder(waveSpeed.z * waveScale4.z * Time.deltaTime / 20, 1.0),
